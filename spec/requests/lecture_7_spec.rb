...
describe "lecture 7" do
  ...
  def should_be_on_home_page
    expect(page).to have_selector('h1', text: 'INFO 2310 MicroPoster')
  end
  ...
  def should_have_notice(msg)
    expect(page).to have_selector('div.alert-notice', text: msg)
  end
  ...
  describe "user feed" do
    ...
    describe "anonymous" do
      it "should not appear on the home page" do
        visit root_path
        expect(page).not_to have_css('#user_feed')
      end
    end
  ...
  describe "posting from the home page" do
    ...
    describe "anonymous" do
      it "should not display the MicroPost form to anonymous users" do
        visit root_path
        expect(page).not_to have_css "[name='micro_post[content]']"
      end
    end
    ...
    describe "authenticated" do
      ...
      it "should show the MicroPost form" do
        ...
        expect(page).to have_css "[name='micro_post[content]']"
      end
  ...
  describe "deleting micro_posts" do
    ...
    describe "authenticated" do
      ...
      it "should display the destroy link for only your micro_posts" do
        visit root_path
        expect(page).to have_css "a[data-remote='true'][data-method='delete']"
      end
      ...
      it "should not display destroy links for other users micro_posts" do
        ...
        expect(page).not_to have_css "a[data-remote='true'][data-method='delete']"
      end
    end
  end
end